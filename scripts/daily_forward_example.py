"""
Forward the δHBV2.0 (daily) BMI on a single catchment with pseudo-NextGen
operating behavior.

This script demonstrates daily forecasting in an hourly framework.
The daily BMI:
1. Receives hourly forcing data from ngen
2. Aggregates them internally to daily values
